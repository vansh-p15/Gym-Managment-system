...
const Attendance = () => {
  ...
  const handleCheckIn = async () => {
    ...
    setError('');
    try {
      const data = await api.post('/trainer/attendance/checkin', {});
  ...
  const handleCheckOut = async () => {
    ...
    setError('');
    try {
      const data = await api.put('/trainer/attendance/checkout', {});
  ...
  return (
    <div>
      <h3 className="fw-bold mb-4">
        <i className="bi bi-calendar2-check me-2 text-danger"></i>Trainer Attendance
      </h3>
